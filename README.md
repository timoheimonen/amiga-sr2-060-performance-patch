...
**Version 1.8.2** removes the Camaro opening picture and compression, so the
game starts directly with the original cracktro. Includes the CPU road-polygon
and span fills, the startup FPS menu and the KS3.1/AGA/68060 compatibility and
performance fixes.
...
Versions 1.2.0–1.8.2 use the A1200/68060 configuration listed above.
